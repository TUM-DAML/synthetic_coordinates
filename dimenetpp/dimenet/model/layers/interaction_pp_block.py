...
class InteractionPPBlock(layers.Layer):
    def __init__(
        ...
        **kwargs
        ...
        self.dense_rbf1 = layers.Dense(
            basis_emb_size, use_bias=False, kernel_initializer=weight_init
        )
        self.dense_rbf2 = layers.Dense(
            emb_size, use_bias=False, kernel_initializer=weight_init
        )
        self.dense_sbf1 = layers.Dense(
            basis_emb_size, use_bias=False, kernel_initializer=weight_init
        )
        self.dense_sbf2 = layers.Dense(
            int_emb_size, use_bias=False, kernel_initializer=weight_init
        )

        # Dense transformations of input messages
        self.dense_ji = layers.Dense(
            emb_size,
            activation=activation,
            use_bias=True,
            kernel_initializer=weight_init,
        )
        self.dense_kj = layers.Dense(
            emb_size,
            activation=activation,
            use_bias=True,
            kernel_initializer=weight_init,
        ...
        # Dense transformation of edge embedding
        ...
        self.down_projection = layers.Dense(
            int_emb_size,
            activation=activation,
            use_bias=False,
            kernel_initializer=weight_init,
        ...
        self.final_before_skip = layers.Dense(
            emb_size,
            activation=activation,
            use_bias=True,
            kernel_initializer=weight_init,
    ...
    def call(self, inputs):
        x, edge_emb, rbf, sbf, id_expand_kj, id_reduce_ji = inputs
        ...
        rbf_edge_emb = tf.concat([rbf, edge_emb], axis=-1)
        rbf_edge_emb = self.dense_rbf2(rbf_edge_emb)
        x_kj = x_kj * rbf_edge_emb
