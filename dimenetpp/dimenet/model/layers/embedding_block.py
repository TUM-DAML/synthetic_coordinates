...
class EmbeddingBlock(layers.Layer):
    def __init__(self, emb_size, activation=None,
        ...
        self.dense_node = layers.Dense(self.emb_size, activation=activation, use_bias=True,
                                       kernel_initializer=self.weight_init)
        self.dense_edge = layers.Dense(self.emb_size, activation=activation, use_bias=True,
                                       kernel_initializer=self.weight_init)
